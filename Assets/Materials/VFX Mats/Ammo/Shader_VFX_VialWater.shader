...
Shader "Water"
{
	Properties
	{
		...
		_NoiseCull("NoiseCull", Vector) = (0.9,2,0,0)
		_NoiseScale("NoiseScale", Float) = 0
		_Noise_Colour("Noise_Colour", Color) = (0.7349778,0.2313725,0.8588235,1)
		_Diffuse_Colour_Backface("Diffuse_Colour_Backface", Color) = (0.5176471,0.3215686,0.8588236,1)
		_ColourGradientSmoothStep("ColourGradientSmoothStep", Vector) = (0,1,0,0)
		[ASEEnd]_NoisePanner("NoisePanner", Vector) = (0.1,0.1,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN , FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float temp_output_3_0_g9 = ( min( saturate( dotResult169 ) , ase_lightAtten ) - 0.1 );
				...
				float temp_output_142_0 = (-1.3 + (_WaterLevel - 0.0) * (1.0 - -1.3) / (1.0 - 0.0));
				float Fill316 = temp_output_142_0;
				...
				float4 NoiseColour309 = _Noise_Colour;
				float3 worldToObj297 = mul( GetWorldToObjectMatrix(), float4( WorldPosition, 1 ) ).xyz;
				float2 panner357 = ( 1.0 * _Time.y * _NoisePanner + worldToObj297.xy);
				float simplePerlin3D287 = snoise( float3( panner357 ,  0.0 )*_NoiseScale );
				simplePerlin3D287 = simplePerlin3D287*0.5 + 0.5;
				float smoothstepResult300 = smoothstep( ( _NoiseCull.x - Fill316 ) , ( _NoiseCull.y - Fill316 ) , ( 1.0 - worldToObj297.y ));
				float4 lerpResult301 = lerp( lerpResult266 , ( NoiseColour309 * (-0.4 + (simplePerlin3D287 - 0.0) * (2.0 - -0.4) / (1.0 - 0.0)) ) , ( simplePerlin3D287 * smoothstepResult300 ));
				float4 DiffuseColour267 = lerpResult301;
				...
				float temp_output_3_0_g10 = ( fresnelNode243 - 0.1 );
				float temp_output_245_0 = saturate( ( temp_output_3_0_g10 / fwidth( temp_output_3_0_g10 ) ) );
				...
				float4 switchResult163 = (((ase_vface>0)?(( ( float4( ( temp_output_174_0 + ( ( 1.0 - temp_output_174_0 ) * ( bakedGI173 * float3( 2,2,2 ) ) ) ) , 0.0 ) * _MainLightColor * DiffuseColour267 ) + ( ( NormalDotLightStep254 * temp_output_245_0 * _MainLightColor * _Highlight_Strenght ) + float4( ( ( 1.0 - NormalDotLightStep254 ) * temp_output_245_0 * bakedGI249 * _Rim_Strenght ) , 0.0 ) ) )):(Backface279)));
				...
				float3 temp_cast_4 = (worldToObj136.x).xxx;
				float3 rotatedValue187 = RotateAroundAxis( float3( 1,0,0 ), worldToObj136, temp_cast_4, 90.0 );
				float3 temp_cast_5 = (worldToObj136.z).xxx;
				float3 rotatedValue189 = RotateAroundAxis( float3( 0,0,1 ), worldToObj136, temp_cast_5, 90.0 );
				...
				float smoothstepResult138 = smoothstep( temp_output_142_0 , 1.0 , ( ( ( ( lerpResult199 * rotatedValue187 ) + ( rotatedValue189 * lerpResult208 ) ) + worldToObj361 ).y + ( ( WorldPosition.x * ( temp_output_146_0 * _Float1 ) ) + ( WorldPosition.z * temp_output_146_0 ) ) ));
				float WhiteStrip262 = ( step( smoothstepResult138 , 0.4 ) - step( smoothstepResult138 , 0.01 ) );
				...
				float temp_output_3_0_g11 = ( pow( dotResult333 , exp2( ( ( _Spec_Smoothness * 10.0 ) + 1.0 ) ) ) - 0.1 );
				float4 Specular325 = ( saturate( ( temp_output_3_0_g11 / fwidth( temp_output_3_0_g11 ) ) ) * _Spec_Colour * _Spec_Smoothness );
				float4 Colour258 = ( Diffuse260 + WhiteStrip262 + Specular325 );
...
/*ASEBEGIN
Version=18935
-1280;9;1280;659;-1571.363;4448.766;4.606864;True;False
Node;AmplifyShaderEditor.CommentaryNode;265;3992.024,-3641.394;Inherit;False;3106.332;1680.092;Liquid;47;203;202;135;204;206;207;136;200;187;199;208;147;189;148;146;191;149;190;153;145;188;150;152;194;137;151;134;142;138;154;140;143;256;221;224;222;262;261;258;263;215;270;314;316;340;360;361;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.WorldPosInputsNode;360;4493.493,-2806.006;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;153;4962.992,-2557.489;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TransformPositionNode;361;4683.201,-2799.682;Inherit;False;World;Object;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;150;5115.299,-2656.973;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;134;5053.251,-2780.036;Inherit;False;Property;_WaterLevel;WaterLevel;28;0;Create;True;0;0;0;False;0;False;0;0.504;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;154;5756.042,-2964.158;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;142;5349.978,-2797.521;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;-1.3;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SmoothstepOpNode;138;5982.409,-2901.768;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;322;7138.045,-3640.159;Inherit;False;1625.947;1790.751;Colours;32;300;305;279;310;311;309;297;296;312;302;304;318;315;319;321;299;320;287;267;272;313;317;308;179;266;303;301;269;271;357;358;359;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;264;1064.814,-2990.814;Inherit;False;2861.628;1023.345;Cel Water;33;173;170;174;167;172;184;171;182;181;178;175;169;168;176;254;247;251;248;246;250;242;253;252;249;244;245;243;241;240;163;260;268;280;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;267;8539.991,-2792.38;Inherit;False;DiffuseColour;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;300;8062.479,-2255.95;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0.89;False;2;FLOAT;1.9;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;305;7566.526,-3418.734;Inherit;False;Property;_Noise_Colour;Noise_Colour;34;0;Create;True;0;0;0;False;0;False;0.7349778,0.2313725,0.8588235,1;1,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.BreakToComponentsNode;314;4919.391,-2750.749;Inherit;False;FLOAT3;1;0;FLOAT3;0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.ColorNode;269;7577.354,-3056.824;Inherit;False;Property;_Diffuse_Colour_Bottom;Diffuse_Colour_Bottom;2;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;0.7058825,0,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleSubtractOpNode;320;7881.076,-2103.408;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;301;8336.826,-2717.913;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;258;4806.313,-2167.088;Inherit;False;Colour;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;179;7566.701,-3234.417;Inherit;False;Property;_Diffuse_Colour_Top;Diffuse_Colour_Top;5;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;0,1,0.8745098,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;313;7188.045,-2699.314;Inherit;False;Property;_ColourGradientSmoothStep;ColourGradientSmoothStep;36;0;Create;True;0;0;0;False;0;False;0,1;0,2.17;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RegisterLocalVarNode;279;7860.504,-3581.806;Inherit;False;Backface;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;310;8199.196,-2606.231;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;244;2516.026,-2083.469;Inherit;False;Property;_Rim_Strenght;Rim_Strenght;11;0;Create;True;0;0;0;False;0;False;1;1.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StepOpNode;224;6345.542,-3205.388;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0.01;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;327;2431.625,-3285.661;Inherit;False;Property;_Spec_Smoothness;Spec_Smoothness;3;0;Create;True;0;0;0;False;0;False;0.954;0.453;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;321;7619.076,-1964.408;Inherit;False;316;Fill;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;340;4200.342,-2159.933;Inherit;False;325;Specular;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;329;3257.85,-3272.762;Inherit;False;Property;_Spec_Colour;Spec_Colour;4;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,0;1.498039,1.498039,1.498039,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;334;3295.186,-3428.294;Inherit;False;Step Antialiasing;-1;;11;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0.1;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;316;5712.819,-2700.958;Inherit;False;Fill;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;303;7635.562,-2095.255;Inherit;False;Property;_NoiseCull;NoiseCull;32;0;Create;True;0;0;0;False;0;False;0.9,2;0.8,1.8;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;358;7203.587,-2495.969;Inherit;False;Property;_NoisePanner;NoisePanner;37;0;Create;True;0;0;0;False;0;False;0.1,0.1;0.1,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.GetLocalVarNode;259;4991.604,-1359.805;Inherit;False;258;Colour;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.PannerNode;357;7399.587,-2470.969;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.OneMinusNode;299;7885.341,-2270.834;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;309;7856.541,-3422.256;Inherit;False;NoiseColour;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;308;7570.049,-3590.159;Inherit;False;Property;_Diffuse_Colour_Backface;Diffuse_Colour_Backface;35;0;Create;True;0;0;0;False;0;False;0.5176471,0.3215686,0.8588236,1;0.3647057,0,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;174;1954.923,-2815.463;Inherit;True;Step Antialiasing;-1;;9;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0.1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;302;8358.05,-2416.51;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;319;7889.076,-2198.407;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;311;8014.196,-2620.231;Inherit;False;309;NoiseColour;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;175;2206.345,-2567.126;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;2,2,2;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;215;4532.25,-2228.598;Inherit;True;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;245;2286.55,-2238.534;Inherit;True;Step Antialiasing;-1;;10;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0.1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LightColorNode;182;2675.448,-2635.194;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;262;6874.357,-3395.569;Inherit;False;WhiteStrip;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;176;2262.885,-2669.221;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;246;2117.874,-2403.958;Inherit;False;Property;_Highlight_Strenght;Highlight_Strenght;8;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StepOpNode;221;6344.375,-3415.034;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0.4;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;222;6633.28,-3387.762;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;166;4993.677,-1202.282;Inherit;False;Constant;_Float2;Float 2;22;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;178;2470.79,-2673.543;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;241;1769.433,-2174.22;Inherit;False;Property;_RimDistance;RimDistance;6;0;Create;True;0;0;0;False;0;False;0.65;1.08;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;251;2668.229,-2488.556;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;3;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;268;2831.367,-2568.759;Inherit;False;267;DiffuseColour;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;359;7890.354,-2524.345;Inherit;True;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;-0.4;False;4;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;263;4191.768,-2246.417;Inherit;False;262;WhiteStrip;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldPosInputsNode;296;7170.372,-2278.974;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.TransformPositionNode;297;7360.371,-2208.974;Inherit;False;World;Object;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;304;7205.328,-2361.095;Inherit;False;Property;_NoiseScale;NoiseScale;33;0;Create;True;0;0;0;False;0;False;0;6.84;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;287;7604.697,-2432.368;Inherit;True;Simplex3D;True;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;14.84;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;257;4983.815,-1280.229;Inherit;False;256;Alpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;233;5286.365,-1395.454;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;3;Water;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;True;True;2;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;0;0;  Blend;0;0;Two Sided;0;638026329172051597;Cast Shadows;0;638026329335421153;  Use Shadow Threshold;0;0;Receive Shadows;1;638026329354727031;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;638026364917304022;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;5;False;True;False;True;False;False;;False;0
...
WireConnection;300;2;320;0
WireConnection;3;0;1;0
WireConnection;314;0;361;0
WireConnection;320;0;303;2
WireConnection;320;1;321;0
WireConnection;301;0;266;0
...
WireConnection;215;1;263;0
WireConnection;215;2;340;0
...
WireConnection;359;0;287;0
WireConnection;297;0;296;0
WireConnection;287;0;357;0
WireConnection;287;1;304;0
...
ASEEND*/
//CHKSM=80195C67271865D53039662E955968C424E69B40