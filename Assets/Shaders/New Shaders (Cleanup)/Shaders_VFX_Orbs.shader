	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_3_0_g27 = ( _Element_Spec_StepValue - ElementVoronoi_1327 );
				float lerpResult505 = lerp( 1.0 , 0.0 , _Toggle_Element_Spec_On0_Off1);
				float ElementBrightParts266 = ( ( ( ( temp_output_261_0 * ( temp_output_261_0 * ( saturate( ( temp_output_3_0_g27 / fwidth( temp_output_3_0_g27 ) ) ) * SoftEdgeMask249 ) ) ) * _Element_Specs_Intensity ) * Base_BottomCull72 ) * lerpResult505 );
				...
				float temp_output_3_0_g26 = ( CatalystNoise_2228 - CatalystNoise_1227 );
				float temp_output_338_0 = ( (_Catalyst_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.z + (CatalystNoise_1227 - _Catalyst_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.x) * (_Catalyst_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.w - _Catalyst_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.z) / (_Catalyst_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.y - _Catalyst_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.x)) * saturate( ( temp_output_3_0_g26 / fwidth( temp_output_3_0_g26 ) ) ) );
...
/*ASEBEGIN
Version=18935
252;271;1100;643;-1136.694;934.4674;1.35867;True;False
...
Node;AmplifyShaderEditor.FunctionNode;259;-3482.693,3020.721;Inherit;False;Step Antialiasing;-1;;27;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0.4;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;345;-3326.268,691.1461;Inherit;False;Step Antialiasing;-1;;26;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0.6;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=7859C7FF8B6A1F8A8F5C848A1D5CBA60C5B59FCE