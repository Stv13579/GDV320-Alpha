	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_3_0_g33 = ( _Element_Spec_StepValue - ElementVoronoi_1327 );
				float lerpResult505 = lerp( 1.0 , 0.0 , _Toggle_Element_Spec_On0_Off1);
				float ElementBrightParts266 = ( ( ( ( temp_output_261_0 * ( temp_output_261_0 * ( saturate( ( temp_output_3_0_g33 / fwidth( temp_output_3_0_g33 ) ) ) * SoftEdgeMask249 ) ) ) * _Element_Specs_Intensity ) * Base_BottomCull72 ) * lerpResult505 );
				...
				float temp_output_3_0_g34 = ( CatalystNoise_2228 - CatalystNoise_1227 );
				float temp_output_338_0 = ( (_Catalyst_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.z + (CatalystNoise_1227 - _Catalyst_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.x) * (_Catalyst_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.w - _Catalyst_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.z) / (_Catalyst_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.y - _Catalyst_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.x)) * saturate( ( temp_output_3_0_g34 / fwidth( temp_output_3_0_g34 ) ) ) );
				...
				float temp_output_3_0_g32 = ( _Catalyst_Spec_StepValue - CatalystVoronoi_1325 );
				float lerpResult509 = lerp( 1.0 , 0.0 , _Toggle_Cataylst_Spec_On0_Off1);
				float CatalystBrightParts348 = ( ( ( ( temp_output_338_0 * ( temp_output_338_0 * ( saturate( ( temp_output_3_0_g32 / fwidth( temp_output_3_0_g32 ) ) ) * SoftEdgeMask249 ) ) ) * _Catalyst_Specs_Intensity ) * Base_TopCull71 ) * lerpResult509 );
...
/*ASEBEGIN
Version=18935
175;362;1582;539;12832.21;2241.87;11.34858;True;False
...
Node;AmplifyShaderEditor.FunctionNode;346;-3326.164,793.4901;Inherit;False;Step Antialiasing;-1;;32;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0.4;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;259;-3482.693,3020.721;Inherit;False;Step Antialiasing;-1;;33;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0.4;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;345;-3326.268,691.1461;Inherit;False;Step Antialiasing;-1;;34;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0.6;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;473;629.8297,13.35383;Inherit;False;Property;_VertOffset_Intensity;VertOffset_Intensity;22;0;Create;True;0;0;0;False;0;False;0;0.04;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=BF6D935E0D8DBBB8DE8A590F29856DD727867D3C