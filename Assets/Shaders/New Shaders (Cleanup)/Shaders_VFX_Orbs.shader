	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_3_0_g31 = ( ElementNoise_2166 - ElementNoise_161 );
				float temp_output_261_0 = ( (_Element_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.z + (ElementNoise_161 - _Element_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.x) * (_Element_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.w - _Element_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.z) / (_Element_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.y - _Element_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.x)) * saturate( ( temp_output_3_0_g31 / fwidth( temp_output_3_0_g31 ) ) ) );
				...
				float temp_output_3_0_g29 = ( _Element_Spec_StepValue - ElementVoronoi_1327 );
				float lerpResult505 = lerp( 1.0 , 0.0 , _Toggle_Element_Spec_On0_Off1);
				float ElementBrightParts266 = ( ( ( ( temp_output_261_0 * ( temp_output_261_0 * ( saturate( ( temp_output_3_0_g29 / fwidth( temp_output_3_0_g29 ) ) ) * SoftEdgeMask249 ) ) ) * _Element_Specs_Intensity ) * Base_BottomCull72 ) * lerpResult505 );
				...
				float temp_output_3_0_g30 = ( CatalystNoise_2228 - CatalystNoise_1227 );
				float temp_output_338_0 = ( (_Catalyst_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.z + (CatalystNoise_1227 - _Catalyst_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.x) * (_Catalyst_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.w - _Catalyst_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.z) / (_Catalyst_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.y - _Catalyst_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW.x)) * saturate( ( temp_output_3_0_g30 / fwidth( temp_output_3_0_g30 ) ) ) );
				...
				float temp_output_3_0_g28 = ( _Catalyst_Spec_StepValue - CatalystVoronoi_1325 );
				float lerpResult509 = lerp( 1.0 , 0.0 , _Toggle_Cataylst_Spec_On0_Off1);
				float CatalystBrightParts348 = ( ( ( ( temp_output_338_0 * ( temp_output_338_0 * ( saturate( ( temp_output_3_0_g28 / fwidth( temp_output_3_0_g28 ) ) ) * SoftEdgeMask249 ) ) ) * _Catalyst_Specs_Intensity ) * Base_TopCull71 ) * lerpResult509 );
				...
				float4 clampResult521 = clamp( temp_output_445_0 , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 Colour8 = clampResult521;
				...
				float clampResult522 = clamp( ( ( (0.01 + (grayscale462 - 0.0) * (4.0 - 0.01) / (1.0 - 0.0)) * VertexAlpha297 ) * DisolveAlpha93 ) , 0.0 , 1.0 );
				float Alpha9 = clampResult522;
...
/*ASEBEGIN
Version=18935
-1192;537;1034;423;963.2558;594.4067;1.74759;True;False
...
Node;AmplifyShaderEditor.Vector4Node;177;-6068.514,1974.41;Inherit;False;Property;_Catalyst_Flash_Slot1X_Slot2Y_Slot3Z_Slot4W;Catalyst_Flash_Slot1(X)_Slot2(Y)_Slot3(Z)_Slot4(W);43;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleTimeNode;114;-5973.378,1904.062;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;144;-5040.981,1935.557;Inherit;False;Property;_Cataylst_Tex_Pan_Slot1XY_Slot2ZW;Cataylst_Tex_Pan_Slot1(X/Y)_Slot2(Z/W);44;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;175;-5384.047,2756.616;Inherit;False;Property;_Element_Tex_Pan_Slot1_Slot2;Element_Tex_Pan_Slot1_Slot2;30;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,1,-1,-1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;211;-6051.794,2740.105;Inherit;False;Property;_ElementNoise_Pan_Speed_Noise1XY_Noise2ZW;ElementNoise_Pan_Speed_Noise1(X/Y)_Noise2(Z/W);35;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.7,0.7,-0.7,-0.7;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;234;-5973.397,2975.468;Inherit;False;Property;_NoiseScales_E1X_E2Y_C1Z_C2W;NoiseScales_E1(X)_E2(Y)_C1(Z)_C2(W);23;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,10,2.26,27.51;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;298;-4722.359,2817.946;Inherit;False;Property;_ElementVoronoi_Speed1X_Speed2Y_Scale1Z_Scale2W;ElementVoronoi_Speed1(X)_Speed2(Y)_Scale1(Z)_Scale2(W);36;0;Create;True;0;0;0;False;0;False;0,0,0,0;2,4,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;292;-5613.511,2486.143;Inherit;False;Property;_CatalystVoronoi_Speed1X_Speed2Y_Scale1Z_Scale2W;CatalystVoronoi_Speed1(X)_Speed2(Y)_Scale1(Z)_Scale2(W);47;0;Create;True;0;0;0;False;0;False;0,0,0,0;5.99,10,11.6,16.68;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;133;-3351.984,-858.467;Inherit;True;Property;_CatalystTexture_Slot_2;CatalystTexture_Slot_2;40;0;Create;True;0;0;0;False;0;False;-1;None;5512be1e0e083f24eb6f50956c6066f6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;128;-3269.506,1125.861;Inherit;True;Property;_ElementTexture_Slot_1;ElementTexture_Slot_1;26;0;Create;True;0;0;0;False;0;False;-1;None;bcf9928001deb8c4485e99ef210908a9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;129;-3264.09,1318.481;Inherit;True;Property;_ElementTexture_Slot_2;ElementTexture_Slot_2;27;0;Create;True;0;0;0;False;0;False;-1;None;bf00e325700b0714d8090cb909018828;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;40;-5598.977,601.0563;Inherit;False;Property;_Fres_Power_MaxNew;Fres_Power_MaxNew;61;0;Create;True;0;0;0;False;0;False;5;-0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;42;-5598.977,528.0563;Inherit;False;Property;_Fres_Power_MinNew;Fres_Power_MinNew;60;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;391;-3568.91,-43.99763;Inherit;False;Property;_Toggle_UseCatalystTexture_1_With_Noise_1;Toggle_UseCatalystTexture_1_With_Noise_1;16;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;423;-3705.751,2186.466;Inherit;False;Property;_Toggle_UseElementTexture_1_With_Noise_1;Toggle_UseElementTexture_1_With_Noise_1;13;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;268;-3810.62,2661.135;Inherit;False;Property;_Element_Specs_Remap_MinOldX_MaxOldY_MinNewZ_MaxNewW;Element_Specs_Remap_MinOld(X)_MaxOld(Y)_MinNew(Z)_MaxNew(W);34;0;Create;True;0;0;0;False;0;False;0,1,0,1;0,1,0,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;426;-3267.433,2627.49;Inherit;False;Property;_Element_Base_Noise_2_Remap;Element_Base_Noise_2_Remap;50;0;Create;True;0;0;0;False;0;False;0,1,0,1;0,1,0,1.5;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;28;-6000.381,-881.1287;Inherit;False;Property;_BaseColour_Catalyst;BaseColour_Catalyst;37;1;[HDR];Create;True;0;0;0;False;0;False;0,0.7648358,1,0;14.75442,9.810533,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;279;-6037.036,-537.4227;Inherit;False;Property;_SecondaryColour_Element;SecondaryColour_Element;25;1;[HDR];Create;True;0;0;0;False;0;False;1,0.8760238,0,0;0,0.0810846,2.297397,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;257;-3482.798,2918.377;Inherit;False;Step Antialiasing;-1;;31;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0.6;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;346;-3326.164,793.4901;Inherit;False;Step Antialiasing;-1;;28;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0.4;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;62;-5643.479,1127.17;Inherit;False;Property;_ToggleElementCull;ToggleElementCull;5;0;Create;True;0;0;0;False;0;False;0.1294118;0.23;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;64;-5263.096,794.3367;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;259;-3482.693,3020.721;Inherit;False;Step Antialiasing;-1;;29;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0.4;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;345;-3326.268,691.1461;Inherit;False;Step Antialiasing;-1;;30;2a825e80dfb3290468194f83380797bd;0;2;1;FLOAT;0;False;2;FLOAT;0.6;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;66;-5403.319,984.3571;Inherit;False;Property;_ToggleCatalystFade;ToggleCatalystFade;8;0;Create;True;0;0;0;False;0;False;0;-0.8;-100;100;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;25;-6006.518,-1051.512;Inherit;False;Property;_BaseColour_Element;BaseColour_Element;24;1;[HDR];Create;True;0;0;0;False;0;False;1,0,0,0;0,0.3964136,1.148698,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;376;-2457.9,114.9592;Inherit;False;Property;_Catalyst_Base_Remap;Catalyst_Base_Remap;53;0;Create;True;0;0;0;False;0;False;0,1,0,1;0,1,0,30;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;402;-2594.74,2345.423;Inherit;False;Property;_Element_Base_Remap;Element_Base_Remap;52;0;Create;True;0;0;0;False;0;False;0,1,0,1;0,1,0.2,5;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;267;-2912.027,2968.728;Inherit;False;Property;_Element_Specs_Intensity;Element_Specs_Intensity;33;0;Create;True;0;0;0;False;0;False;1;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;508;-2498.7,3117.382;Inherit;False;Property;_Toggle_Element_Spec_On0_Off1;Toggle_Element_Spec_On(0)_Off(1);19;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;492;-623.1014,-1152.216;Inherit;False;2944.291;1369.31;Combine;61;4;3;2;481;450;451;447;448;479;484;482;456;454;438;427;442;435;439;443;436;432;459;483;434;453;485;455;440;441;458;433;457;444;437;452;449;446;445;470;471;462;469;473;464;465;468;475;467;472;463;474;466;10;9;8;517;518;520;519;521;522;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;441;214.6882,-439.849;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;440;194.5355,-320.138;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;444;381.8401,-408.0479;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;83;-5568.47,1712.979;Inherit;False;Property;_ToggleOverallFade;ToggleOverallFade;9;0;Create;True;0;0;0;False;0;False;0;2.5;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;473;629.8297,13.35383;Inherit;False;Property;_VertOffset_Intensity;VertOffset_Intensity;22;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;522;2098.633,-556.757;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;9;2133.873,-707.895;Inherit;False;Alpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;521;1176.361,-761.4695;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;7;488.8409,1654.585;Inherit;False;10;VertexOffset;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;8;1327.377,-759.6699;Inherit;False;Colour;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;522;0;466;0
WireConnection;474;0;475;0
WireConnection;474;1;472;0
WireConnection;10;0;474;0
WireConnection;9;0;522;0
WireConnection;521;0;445;0
WireConnection;8;0;521;0
WireConnection;1;2;5;0
WireConnection;1;3;6;0
WireConnection;1;5;7;0
ASEEND*/
//CHKSM=02D5F835A41058B9925AB09C31FC86E82050A335