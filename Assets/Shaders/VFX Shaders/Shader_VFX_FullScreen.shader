...
Shader "Shader_VFX_FullScreen"
{
	Properties
	{
		...
		[ASEEnd]_SmoothStepFade("SmoothStepFade", Range( -2 , 0.99)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 coords17 = IN.ase_texcoord3.xy * 4.0;
				float2 id17 = 0;
				float2 uv17 = 0;
				float fade17 = 0.5;
				float voroi17 = 0;
				...
				float2 coords62 = IN.ase_texcoord3.xy * 4.0;
				float2 id62 = 0;
				float2 uv62 = 0;
				float fade62 = 0.5;
				float voroi62 = 0;
				...
				float2 coords80 = IN.ase_texcoord3.xy * 4.0;
				float2 id80 = 0;
				float2 uv80 = 0;
				float fade80 = 0.5;
				float voroi80 = 0;
				...
				float FullScreenEffect29 = lerpResult38;
				float3 worldToObj47 = mul( GetWorldToObjectMatrix(), float4( WorldPosition, 1 ) ).xyz;
				float smoothstepResult48 = smoothstep( 1.0 , _SmoothStepFade , worldToObj47.y);
				float clampResult54 = clamp( smoothstepResult48 , 0.0 , 1.0 );
				float VerticalMasking55 = clampResult54;
				float4 lerpResult12 = lerp( tex2D( _MainTex, uv_MainTex ) , ( ( FullScreenEffect29 * VerticalMasking55 ) * _BaseColour ) , _Toggle_EffectIntensity);
...
/*ASEBEGIN
Version=18935
0;0;1920;1019;3755.152;-347.981;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;16;206.712,-526.8884;Inherit;False;370;280;Do Not Touch, Will Break Shader;1;11;;1,1,1,1;0;0
Node;AmplifyShaderEditor.PowerNode;7;545.0674,-1095.571;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;317.2404,-235.1265;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;40;-294.4664,639.4801;Inherit;False;Property;_Toggle_Array12;Toggle_Array 1 & 2 ;2;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;55;-603.7645,-1111.193;Inherit;False;VerticalMasking;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;48;-983.0221,-1113.879;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;49;-1307.372,-981.184;Inherit;False;Constant;_SmoothStepCull;SmoothStepCull;9;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;46;-1501.895,-1117.611;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;52;-1351.862,-903.2716;Inherit;False;Property;_SmoothStepFade;SmoothStepFade;10;0;Create;True;0;0;0;False;0;False;0;0;-2;0.99;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;10;195.7145,-954.5708;Inherit;False;Property;_VignettePowerExp;VignettePowerExp;9;0;Create;True;0;0;0;False;0;False;8.29;7.17;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;29;535.3445,292.5116;Inherit;False;FullScreenEffect;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;54;-742.1935,-1105.65;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;31;11.52065,-161.7188;Inherit;False;Property;_BaseColour;BaseColour;6;1;[HDR];Create;True;0;0;0;False;0;False;1,0,0,0;10.43295,1.147078,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TransformPositionNode;47;-1325.283,-1124.213;Inherit;False;World;Object;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;84;-2353.55,758.3516;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;19;-185.7912,-275.7627;Inherit;False;29;FullScreenEffect;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;11;256.7121,-476.8886;Inherit;True;Property;_MainTex;MainTex;7;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;15;767.4828,-106.0476;Inherit;False;Constant;_Alpha;Alpha;4;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;68;-799.6083,75.16736;Inherit;False;65;VFX_Lifesteal;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;396.2294,-118.1402;Inherit;False;Property;_Toggle_EffectIntensity;Toggle_EffectIntensity;0;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;57;-185.8734,-203.1471;Inherit;False;55;VerticalMasking;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;56;22.12668,-257.1472;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;45;-841.4088,153.7796;Inherit;False;Property;_Toggle_BetweenVoidBlinkLifesteal;Toggle_Between VoidBlink & Lifesteal;4;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.VoronoiNode;80;-2797.58,707.1511;Inherit;True;0;0;1;2;5;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
...
Node;AmplifyShaderEditor.RangedFloatNode;86;-2827.686,973.3521;Inherit;False;Constant;_Voronoi_OnFire_Power;Voronoi_OnFire_Power;10;0;Create;True;0;0;0;False;0;False;-0.87;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;83;-2558.685,782.3521;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;87;-3198.685,726.3521;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;85;-2552.932,711.9443;Inherit;False;18;FullScreenMask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;82;-3005.685,752.3521;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;66;-2539.215,288.1225;Inherit;False;18;FullScreenMask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;12;701.4828,-254.0476;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;79;-3155.685,877.3521;Inherit;False;Constant;_Voronoi_OnFire_Scale;Voronoi_OnFire_Scale;9;0;Create;True;0;0;0;False;0;False;4;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;81;-3266.685,800.3519;Inherit;False;Constant;_Voronoi_OnFire_Speed;Voronoi_OnFire_Speed;8;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;88;-2204.588,752.0607;Inherit;True;VFX_OnFire;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;89;-787.8464,236.5975;Inherit;False;88;VFX_OnFire;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;9;183.0666,-1030.571;Inherit;False;Property;_VignetteSmoothness;VignetteSmoothness;8;0;Create;True;0;0;0;False;0;False;0.73;0.55;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=02A5605B5747CC4AFF2F6E21DE63C120DA38C966