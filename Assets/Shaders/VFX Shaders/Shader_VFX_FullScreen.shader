...
Shader "Shader_VFX_FullScreen"
{
	Properties
	{
		...
		_Toggle_BetweenDebuffedEmpty("Toggle_Between Debuffed & Empty", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _Toggle_BetweenDebuffedEmpty;
			...
			return F1;
					...
					float2 voronoihash191( float2 p )
					{
					...
					float voronoi191( float2 v, float time, inout float2 id, inout float2 mr, float smoothness, inout float2 smoothId )
					{
						float2 n = floor( v );
						float2 f = frac( v );
						float F1 = 8.0;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float time191 = ( _TimeParameters.x * 1.0 );
				float2 voronoiSmoothId191 = 0;
				float2 coords191 = temp_output_104_0 * 4.0;
				float2 id191 = 0;
				float2 uv191 = 0;
				float voroi191 = voronoi191( coords191, time191, id191, uv191, 0, voronoiSmoothId191 );
				float VFX_Debuffed194 = ( lerpResult153 * pow( voroi191 , -0.87 ) );
				float lerpResult36 = lerp( VFX_Debuffed194 , 0.0 , _Toggle_BetweenDebuffedEmpty);
...
/*ASEBEGIN
Version=18935
226;24;1533;995;1283.447;-169.3653;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;9;183.0666,-1030.571;Inherit;False;Property;_VignetteSmoothness;VignetteSmoothness;10;0;Create;True;0;0;0;False;0;False;0.64;0.46;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;192.7145,-950.5708;Inherit;False;Property;_VignettePowerExp;VignettePowerExp;11;0;Create;True;0;0;0;False;0;False;5.09;9.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;144;-1301.63,-1855.867;Inherit;True;Property;_Texture0;Texture 0;15;0;Create;True;0;0;0;False;0;False;9a7be70759d48ff48a8ef359791bfa99;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;103;-3815.834,310.1985;Inherit;False;Property;_TexNoiseScale;TexNoiseScale;14;0;Create;True;0;0;0;False;0;False;0;6.69;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;187;-3523.996,2393.783;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;186;-3567.996,2470.782;Inherit;False;Constant;_Voronoi_Slowed_Speed1;Voronoi_Slowed_Speed;8;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;189;-3306.996,2422.783;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;188;-3456.996,2547.783;Inherit;False;Constant;_Voronoi_Slowed_Scale1;Voronoi_Slowed_Scale;9;0;Create;True;0;0;0;False;0;False;4;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;190;-3270.397,2672.083;Inherit;False;Constant;_Voronoi_Slowed_Power1;Voronoi_Slowed_Power;10;0;Create;True;0;0;0;False;0;False;-0.87;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.VoronoiNode;191;-3098.891,2377.581;Inherit;True;0;1;1;1;1;False;1;False;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT2;1;FLOAT2;2
...
Node;AmplifyShaderEditor.RangedFloatNode;155;-2765.712,-211.6918;Inherit;False;Property;_UseFullscreenMaskOrRectangleMask;Use FullscreenMask Or RectangleMask;16;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;192;-2859.996,2452.784;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;193;-2267.096,2416.96;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;194;-2083.69,2414.519;Inherit;False;VFX_Debuffed;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;118;-891.0886,661.0371;Inherit;False;Property;_Toggle_BetweenDamagedSlowed;Toggle_Between Damaged & Slowed;7;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;196;-845.55,744.746;Inherit;False;194;VFX_Debuffed;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;195;-872.55,925.746;Inherit;False;Property;_Toggle_BetweenDebuffedEmpty;Toggle_Between Debuffed & Empty;6;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;90;-856.8464,403.5975;Inherit;False;Property;_Toggle_BetweenOnFireInToxic;Toggle_Between OnFire & InToxic;5;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;43;-802.7615,2.585205;Inherit;False;42;VFX_VoidBlink;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;36;-544.7663,721.08;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;40;-285.4664,767.4801;Inherit;False;Property;_Toggle_Array12;Toggle_Array 1 & 2 ;2;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-281.4665,839.68;Inherit;False;Property;_Toggle_Array34;Toggle_Array 3 & 4 ;3;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;41;-285.3777,913.1262;Inherit;False;Property;_Toggle_Selection12;Toggle_Selection 1 & 2;1;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;49;-1492.372,-1085.184;Inherit;False;Property;_SmoothStepCull;SmoothStepCull;12;0;Create;True;0;0;0;False;0;False;1;1.08;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;52;-1536.862,-1007.272;Inherit;False;Property;_SmoothStepFade;SmoothStepFade;13;0;Create;True;0;0;0;False;0;False;0;0.99;-2;0.99;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;14;959.7652,-142.0639;Inherit;False;Property;_Toggle_EffectIntensity;Toggle_EffectIntensity;0;0;Create;True;0;0;0;False;0;False;0;0;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;31;-85.17972,-300.527;Inherit;False;Property;_BaseColour;BaseColour;8;1;[HDR];Create;True;0;0;0;False;0;False;1,0,0,0;25.33744,118.0354,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;11;1233.828,-1075.279;Inherit;True;Property;_MainTex;MainTex;9;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=2FEDBD64BBE7730738C8503F329C9866CDF01500