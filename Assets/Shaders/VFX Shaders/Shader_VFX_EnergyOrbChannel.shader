...
Shader "VFX_Shader_NecroOrbChannel"
{
	Properties
	{
		...
		[ASEBegin]_UseVoronoiAlso("Use Voronoi Also", Range( 0 , 1)) = 0
		_If("If", Vector) = (0.3,0,1,0)
		_Main("Main", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_125_0 = ( voroi122 * tex2D( _SideGradient, uv_SideGradient ) );
				float4 lerpResult266 = lerp( temp_output_125_0 , float4( 0,0,0,0 ) , _UseVoronoiAlso);
				...
				float4 clampResult200 = clamp( (temp_cast_4 + (pow( ( ( ( ElecticalCurrents259 * 3.0 ) * temp_output_125_0 ) + lerpResult266 ) , temp_cast_1 ) - temp_cast_2) * (temp_cast_5 - temp_cast_4) / (temp_cast_3 - temp_cast_2)) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
				float4 temp_output_203_0 = ( clampResult200 * _Emissive * IN.ase_color );
				float2 uv_Main = IN.ase_texcoord3.xy * _Main_ST.xy + _Main_ST.zw;
				float4 tex2DNode181 = tex2D( _Main, uv_Main );
				float clampResult190 = clamp( ( tex2DNode181.a * _Opacity ) , 0.0 , 1.0 );
				...
				float4 appendResult194 = (float4(( ( _Main_Colour * IN.ase_color ) + temp_output_203_0 ).rgb , appendResult193.x));
				...
				float Alpha = ( ( temp_output_203_0 * tex2DNode181.r ).r * Disolve231 );
...
/*ASEBEGIN
Version=18935
215;149;1582;693;3434.049;299.5347;2.84068;True;False
Node;AmplifyShaderEditor.Vector2Node;262;-4446.55,-1056.955;Inherit;False;Property;_PanningSpeed2;PanningSpeed2;9;0;Create;True;0;0;0;False;0;False;0,-2;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;240;-4452.17,-717.7523;Inherit;False;Property;_PanningSpeed;PanningSpeed;4;0;Create;True;0;0;0;False;0;False;0,2;0,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;243;-4252.534,-872.6233;Inherit;False;Property;_NoiseScale;NoiseScale;10;0;Create;True;0;0;0;False;0;False;2.78;5.37;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;246;-3774.764,-503.9883;Inherit;False;Property;_PolarPowerEXP;PolarPowerEXP;23;0;Create;True;0;0;0;False;0;False;1.15;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;247;-3857.999,-812.3163;Inherit;False;Property;_PowerEXP;PowerEXP;22;0;Create;True;0;0;0;False;0;False;4.32;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;253;-3579.21,-748.1802;Inherit;False;Property;_Width_Rec;Width_Rec;18;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;252;-3581.866,-662.4873;Inherit;False;Property;_Hight_Rec;Hight_Rec;14;0;Create;True;0;0;0;False;0;False;1.5;4.35;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;112;-3414.729,-391.0016;Inherit;False;Property;_TextureScale;TextureScale;3;0;Create;True;0;0;0;False;0;False;5,5;1,0.25;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;117;-3224.277,-68.58639;Inherit;False;Property;_Noise_Speed;Noise_Speed;6;0;Create;True;0;0;0;False;0;False;5,0;0.1,0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;235;-2862.231,15.05789;Inherit;False;Property;_Voronoi_1_Scale;Voronoi_1_Scale;21;0;Create;True;0;0;0;False;0;False;0;9.76;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;124;-2592.258,50.40567;Inherit;True;Property;_SideGradient;SideGradient;13;0;Create;True;0;0;0;False;0;False;-1;None;b6939a0a96d4bf742bb2cbafe58e8f4d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;267;-2279.704,81.9437;Inherit;False;Property;_UseVoronoiAlso;Use Voronoi Also;0;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;125;-2289.3,-153.2722;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;218;-2006.723,-342.7296;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;266;-2024.904,-111.7563;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;265;-1858.879,-179.2281;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;206;-1933.669,256.7823;Inherit;False;Property;_Voronoi_Power;Voronoi_Power;16;0;Create;True;0;0;0;False;0;False;2;2.65;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;223;-190.2496,1127.545;Inherit;False;Property;_Voronoi_2_Angle;Voronoi_2_Angle;5;0;Create;True;0;0;0;False;0;False;2;1.26;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;222;-189.3876,1201.591;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector4Node;197;-1580.91,135.8674;Inherit;False;Property;_Remaping;Remaping;20;0;Create;True;0;0;0;False;0;False;0,1,0.4,1;0,1,0,40;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;224;30.82751,1206.56;Inherit;False;Property;_Voronoi_2_Scale;Voronoi_2_Scale;7;0;Create;True;0;0;0;False;0;False;3;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;226;-175.7345,1436.976;Inherit;False;Property;_Voronoi_2_Power_Exp;Voronoi_2_Power_Exp;11;0;Create;True;0;0;0;False;0;False;0.7647059;2;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;202;-1072.455,226.3323;Inherit;False;Property;_Emissive;Emissive;19;0;Create;True;0;0;0;False;0;False;1;10;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;203;-530.9771,69.74719;Inherit;True;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;181;-1343.213,492.3944;Inherit;True;Property;_Main;Main;2;0;Create;True;0;0;0;False;0;False;-1;None;379e2786f4192444e985ab5314608bdc;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;270;-206.593,366.222;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;234;271.5571,953.4874;Inherit;False;231;Disolve;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.BreakToComponentsNode;217;300.6951,749.975;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.Vector3Node;185;-1101.95,1208.419;Inherit;False;Property;_If;If;1;0;Create;True;0;0;0;False;0;False;0.3,0,1;0.3,0,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;233;871.1469,751.8582;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;171;-2619.23,623.9706;Inherit;False;Property;_SpeedMainTexUVNoiseZW;Speed MainTex U/V + Noise Z/W;12;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;201;-986.0286,-199.2405;Inherit;False;Property;_Main_Colour;Main_Colour;17;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;0,82.81017,118.0354,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;180;-1166.078,911.3698;Inherit;False;Property;_Opacity;Opacity;8;0;Create;True;0;0;0;False;0;False;20;20;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;205;-176.7345,68.24606;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;182;-1399.739,992.9246;Inherit;True;Property;_Disolve;Disolve;15;0;Create;True;0;0;0;False;0;False;-1;None;bb7c81375e179db4e8b896b8219c8151;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.DynamicAppendNode;193;-302.299,697.9557;Inherit;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
WireConnection;265;0;218;0
WireConnection;265;1;266;0
WireConnection;198;0;265;0
...
WireConnection;270;0;203;0
WireConnection;270;1;181;1
...
ASEEND*/
//CHKSM=41AF6B2A0FBB961CDA88D06D50E0730BD2479EE8